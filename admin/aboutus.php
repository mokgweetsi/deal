...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Deal Act | About us Page</title>
...
<!--textarea class="form-control" name="pagedescription"  required><?php echo htmlentities($row['Description'])?></textarea-->
<textarea name="pagedescription"  rows="5" class="summernote">
