  ...
  <li class="has_sub">
                             ...
                             <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span>Members</span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="add_member.php">Add Member</a></li>
                                    <li><a href="manage_team.php">Manage Members</a></li>
                                </ul>
                            </li> 
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="update-contactinfo.php">Contact us</a></li>
                                </ul>
                            </li>
   <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="fa-bell"></i> <span> News Letter </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="messages.php">Messages </a></li>
                                  <li><a href="unapprove-comment.php">Waiting for Approval </a></li>
                                    <li><a href="manage-comments.php">Approved Emails</a></li>
                                </ul>
                            </li>   
