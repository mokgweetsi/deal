...
$sql = mysqli_query ($con,"insert into tblimages(ImagesTitle,Position,Phone,Image) values('$imgtitle','$imgrole','$imgcontact','$imgnewfile')");
if($sql)
{
...
<tr>
<th width="26%" height="60" scope="row">Position:</th>
<td width="74%"><input type="text" name="role" autocomplete="off" class="form-control" required /></td>
</tr>
<tr>
<th width="26%" height="60" scope="row">Phone:</th>
<td width="74%"><input type="text" name="contact" autocomplete="off" class="form-control" required /></td>
</tr>
<tr>
