...
$query=mysqli_query($con,"update tblimages set imagestitle='$imgtitle',position='$imgrole',phone='$imgcontact', Image='$imgnewfile' where id='$subcatid'");
if($query)
{
...
<html lang="en">
    <head>
        ...
        <title>DEAL ACT| Edit member</title>
