...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>DEAL ACT INVESTEMENT | Admin Panel</title>
                                ...
                                <div class="text-center account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="../index.php" class="text-success">
                                            <span> <img src="../images/dealimage.jpg" alt="" height="56"> </a></span>
                                ...
                                <div class="account-content">
                                    <form class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group ">
                                            <div class="col-xs-12">
                                                <input class="form-control" type="text" required="" name="username" placeholder="Username or email" autocomplete="on">
                                            </div>
                                        </div>
